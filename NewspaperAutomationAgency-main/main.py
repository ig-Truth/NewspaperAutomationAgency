...
class MainWindow:
    def __init__(self, master):
        ...
        self.labelTitle = Label(self.frame, text = "Newspaper Agency Automation Software", font=('times new roman', 30, 'bold'), fg ="#ab23ff", bd=20)
        ...
        self.labelUserType = Label(self.frame1, text = "USER TYPE   ", font = ('times new roman',12,'bold'),bg="#7D8CA3", padx=12)
        ...
        self.usersDrop.config(font = ('times new roman',10,'bold'))
        self.usersDrop.grid(row=0, column=1, padx=(50,50))

        self.labelSetDate = Label(self.frame1, text="SET DATE  ", font=('times new roman', 12, 'bold'),bg="#7D8CA3", padx=12)
        ...
        self.labelUser = Label(self.frame2, text = "USERNAME / USER ID   ", font = ('times new roman',12,'bold'),bg="#7D8CA3", bd=20)
        self.labelUser.grid(row=0, column=0, columnspan=2, pady=10)
        self.username = StringVar()
        self.eUsername = Entry(self.frame2, width=30,font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1, textvariable=self.username)
        self.eUsername.grid(row=0, column=2, columnspan=2, pady=10)

        self.labelPass = Label(self.frame2, text="PASSWORD   ", font=('times new roman', 12, 'bold'),bg="#7D8CA3", bd=20)
        self.labelPass.grid(row=1, column=0, columnspan=2, pady=10)
        self.password = StringVar()
        self.ePass = Entry(self.frame2, show="*", width=30,font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1, textvariable=self.password)
        self.ePass.grid(row=1, column=2, columnspan=2, pady=10)

        # ===========            LOGIN RESET EXIT (FRAME 3)            ===================================================================================

        self.btnLogin = Button(self.frame3, text="Login", command=lambda: self.decide(), font=('times new roman', 12, 'bold'), width=13)
        self.btnLogin.grid(row=0, column=0, padx=11, pady=11)

        self.btnReset = Button(self.frame3, text="Reset", command=lambda: self.reset(), font=('times new roman', 12, 'bold'), width=15)
        self.btnReset.grid(row=0, column=1, padx=11, pady=11)

        self.btnExit = Button(self.frame3, text="Exit", command=lambda: self.exitProgram(), font=('times new roman', 12, 'bold'), width=13)
...
class ManagerWindow:
    def __init__(self, master):
        ...
        self.btnAddCustomers = Button(self.frame1, text="Add Customers",command=lambda: self.addCustomers(), font=('times new roman', 12, 'bold'),width=20)
        self.btnAddCustomers.grid(row=0, column=0, padx=40, pady=22)

        self.btnEditCustomers = Button(self.frame1, text="Edit Customers Details",command=lambda: self.editCustomer(), font=('times new roman', 12, 'bold'), width=20)
        self.btnEditCustomers.grid(row=1, column=0, padx=40, pady=22)

        self.btnAddPublication = Button(self.frame1, text="Add Publication",command=lambda: self.addPublication(), font=('times new roman', 12, 'bold'), width=20)
        self.btnAddPublication.grid(row=2, column=0, padx=40, pady=22)

        self.btnEditPublications = Button(self.frame1, text="Edit Publications",command=lambda: self.editPublication(), font=('times new roman', 12, 'bold'), width=20)
        self.btnEditPublications.grid(row=3, column=0, padx=40, pady=22)

        self.btnCustomerBills = Button(self.frame1, text="Show Customer Bills",command=lambda: self.customerBills(), font=('times new roman', 12, 'bold'), width=20)
        self.btnCustomerBills.grid(row=4, column=0, padx=40, pady=22)

        self.btnSummary = Button(self.frame1, text="Show Summary", command=lambda: self.summary(), font=('times new roman', 12, 'bold'), width=20)
        self.btnSummary.grid(row=5, column=0, padx=40, pady=22)

        self.btnAddDeliverer = Button(self.frame1, text="Add Deliverer", command=lambda: self.addDeliverer(), font=('times new roman', 12, 'bold'),width=20)
        self.btnAddDeliverer.grid(row=6, column=0, padx=40, pady=22)

        self.btnDeliveryDetails = Button(self.frame1, text="Deliverer Details", command=lambda: self.delivererDetails(), font=('times new roman', 12, 'bold'),width=20)
    ...
    def addCustomers(self):
        ...
        self.labelAddCustomers = Label(self.frame2, text="Add Customers", font=('times new roman', 17, 'bold'),
                                       bd=20)
        ...
        self.labelName = Label(self.frameDetails, text="Full Name ", font=('times new roman', 12, 'bold'), bd=10, bg="SkyBlue2", justify=LEFT)
        self.labelName.grid(row=0, column=0, rowspan=2)
        self.name = StringVar()
        self.eName = Entry(self.frameDetails, width=30, font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1,
                            textvariable=self.name)
        self.eName.grid(row=2, column=0,padx=10)



        self.labelID = Label(self.frameDetails, text="Customer ID", font=('times new roman', 12, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
        self.labelID.grid(row=0, column=1, rowspan=2)
        self.cID = StringVar()
        self.ecID = Entry(self.frameDetails, width=12, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                           borderwidth=1,
        ...
        self.labelPhoneNumber = Label(self.frameDetails, text="Phone Number", font=('times new roman', 12, 'bold'), bd=10,
                                      bg="SkyBlue2", justify = LEFT)
        self.labelPhoneNumber.grid(row=0, column=2, rowspan=2)
        self.phNo = StringVar()
        self.ePhNo = Entry(self.frameDetails, width=12, font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1,
                            textvariable=self.phNo)
        self.ePhNo.grid(row=2, column=2, padx=10)

        # ====================            ADDRESS DETAILS            ===================================================================================

        self.labelAddress = Label(self.frameDetails, text="Address", font=('times new roman', 12, 'bold'), bd=20,
                                      bg="SkyBlue2")
        self.labelAddress.grid(row=0, column=3, columnspan=3)



        self.labelStreetNo = Label(self.frameDetails, text="Street No.", font=('times new roman', 10, 'bold'), bd=10,
                                  bg="SkyBlue2", justify=LEFT)
        self.labelStreetNo.grid(row=1, column=4)
        self.SNo = IntVar()
        self.eSNo = Entry(self.frameDetails, width=5, font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1,
                            textvariable=self.SNo)
        self.eSNo.grid(row=2, column=4, padx=10, pady=10)



        self.labelRoadNo = Label(self.frameDetails, text="Road No.", font=('times new roman', 10, 'bold'), bd=10,
                                   bg="SkyBlue2", justify=LEFT)
        self.labelRoadNo.grid(row=1, column=5)
        self.RNo = IntVar()
        self.eRNo = Entry(self.frameDetails, width=5, font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1,
                           textvariable=self.RNo)
        self.eRNo.grid(row=2, column=5, padx=10, pady=10)


        self.labelHouseNo = Label(self.frameDetails, text="House No.", font=('times new roman', 10, 'bold'), bd=10,
                                 bg="SkyBlue2", justify=LEFT)
        self.labelHouseNo.grid(row=1, column=6)
        self.HNo = StringVar()
        self.eHNo = Entry(self.frameDetails, width=5, font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1,
                           textvariable=self.HNo)
        self.eHNo.grid(row=2, column=6, padx=10, pady=10)

        # ====================          ADD SUBSCRIPTIONS FRAME            ===================================================================================

        self.frameSubs = LabelFrame(self.frame2, text="Add Subscriptions", font=('times new roman', 12, 'bold'), padx=12)
        self.frameSubs.grid(row=3, column=0, pady=20)

        self.paperLanguage = Label(self.frameSubs, text="Language ", font=('times new roman', 12, 'bold'), bd=10)
        self.paperLanguage.grid(row=0, column=0)

        self.v1 = StringVar(self.frameSubs, "English")
        Radiobutton(self.frameSubs, text="English", variable=self.v1, font=('times new roman', 10), command=lambda: self.dropDownPubForSub(),
                    value="English").grid(row=1, column=0)
        Radiobutton(self.frameSubs, text="Hindi", variable=self.v1, font=('times new roman', 10), command=lambda: self.dropDownPubForSub(),
                    value="Hindi").grid(row=1, column=1)
        Radiobutton(self.frameSubs, text="Telugu", variable=self.v1, font=('times new roman', 10), command=lambda: self.dropDownPubForSub(),
        ...
        self.publicationsDrop.config(font=('times new roman', 10, 'bold'))
        self.publicationsDrop.grid(row=2, column=0, padx=10, columnspan=3)

        # ====================          FROM-DATE AND TO-DATE            ===================================================================================

        self.labelFromDate = Label(self.frameSubs, text="From Date", font=('times new roman', 12, 'bold'), bd=10,
                               justify=LEFT)
        ...
        self.labelToDate = Label(self.frameSubs, text="To Date", font=('times new roman', 12, 'bold'), bd=10,
                                   justify=LEFT)
        ...
        self.btnCancel = Button(self.frameSubs, text="Cancel", font=('times new roman', 12, 'bold'), width=20, command=lambda : self.cancelCust())
        self.btnCancel.grid(row=0, column=6, padx=30)

        self.btnAdd = Button(self.frameSubs, text="Add", font=('times new roman', 12, 'bold'), width=20,command=lambda: self.addSubs() )
        self.btnAdd.grid(row=1, column=6, padx=30)

        self.btnDone = Button(self.frameSubs, text="Done", font=('times new roman', 12, 'bold'), width=20,command=lambda: self.doneSubs())
        ...
        self.subs = []
        self.btnAddTop = Button(self.frameDetails, text="Add", font=('times new roman', 12, 'bold'), width=5,
    ...
    def doneSubs(self):
        ...
        for j in self.subs:
            ...
            f = j["from_date"].split("/")
            f = [int(k) for k in f]
            self.ssubs.append(Subscription(sPublications[j["name"]], date(2000 + f[2], f[0], f[1]), date(2000 + t[2], t[0], t[1])))
        customers.append(Customer(self.cID.get(), self.name.get(), Address(self.SNo.get(), self.RNo.get(), self.HNo.get()),
                     self.phNo.get(), self.ssubs))
    ...
    def addPublication(self):
        self.reset()
        # ====================            HEADING             ========================================================================
        self.labelAddPublications = Label(self.frame2, text="Add Publications", font=('times new roman', 17, 'bold'), bd=20)
        ...
        self.paperid = Label(self.frameDetails, text="Paper Id ", font=('times new roman', 12, 'bold'), bd=10, bg="SkyBlue2")
        self.paperid.grid(row=0, column=0)
        self.pid = StringVar()
        self.ePaperID = Entry(self.frameDetails, width=20, font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1,
                          textvariable=self.pid)
        self.ePaperID.grid(row=1, column=0, padx=10)

        self.paperName = Label(self.frameDetails, text="Paper Name ", font=('times new roman', 12, 'bold'), bd=10, bg="SkyBlue2")
        self.paperName.grid(row=0, column=1)
        self.pName = StringVar()
        self.ePaperName = Entry(self.frameDetails, width=20, font=('times new roman', 12), bg="white", fg="black", relief="solid", borderwidth=1, textvariable=self.pName)
        self.ePaperName.grid(row=1, column=1, padx=10)

        self.paperType = Label(self.frameDetails, text="Paper Type ", font=('times new roman', 12, 'bold'), bd=10, bg="SkyBlue2")
        self.paperType.grid(row=2, column=1)
        self.pType = StringVar()
        self.ePaperType = Entry(self.frameDetails, width=20, font=('times new roman', 12), bg="white", fg="black",relief="solid", borderwidth=1, textvariable=self.pType)
        self.ePaperType.grid(row=3, column=1, padx=10)

        self.paperLanguage = Label(self.frameDetails, text="Language ", font=('times new roman', 12, 'bold'), bd=10,
                                   bg="SkyBlue2")
        ...
        Radiobutton(self.frameDetails, text="English", variable=self.v, bg="skyblue2", font=('times new roman',10),
                        value="English").grid(row=3, column=0)
        Radiobutton(self.frameDetails, text="Hindi", variable=self.v, bg="skyblue2",font=('times new roman',10),
                          value="Hindi").grid(row=4, column=0)
        Radiobutton(self.frameDetails, text="Telugu", variable=self.v, bg="skyblue2", font=('times new roman',10),
                          value="Telugu").grid(row=5, column=0)


        self.paperPrice = Label(self.frameDetails, text="Price", font=('times new roman', 12, 'bold'), bd=10, bg="SkyBlue2")
        self.paperPrice.grid(row=4, column=1)
        self.pPrice = DoubleVar()
        self.ePrice = Entry(self.frameDetails, width=20, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                                borderwidth=1, textvariable=self.pPrice)
        self.ePrice.grid(row=5, column=1, padx=10)


        self.btnAddPub = Button(self.frameDetails, text="Add", font=('times new roman', 12, 'bold'),command=lambda: self.addPub(), width=20)
    ...
    def editPublication(self):
        ...
        self.Language = Label(self.frameEditPub, text="Language ", font=('times new roman', 12, 'bold'), bd=10, bg="SkyBlue2")
        self.Language.grid(row=0, column=0)
        self.v1 = StringVar(self.frameEditPub, "English")
        Radiobutton(self.frameEditPub, text="English", variable=self.v1, font=('times new roman', 10), bg="SkyBlue2",
                    command=lambda: self.dropDownPubForSub1(),
                    value="English").grid(row=1, column=0, padx=5)
        Radiobutton(self.frameEditPub, text="Hindi", variable=self.v1, font=('times new roman', 10), bg="SkyBlue2",
                    command=lambda: self.dropDownPubForSub1(),
                    value="Hindi").grid(row=1, column=1, padx=5)
        Radiobutton(self.frameEditPub, text="Telugu", variable=self.v1, font=('times new roman', 10), bg="SkyBlue2",
                    command=lambda: self.dropDownPubForSub1(),
        ...
        self.btnEditPub = Button(self.frameEditPub, text="Edit", font=('times new roman', 12, 'bold'),
    ...
    def EditPub(self, pubName):
        if pubName == "Select Publication":
            ...
            self.reset()
            self.labelTitle = Label(self.frame2, text="Edit Publication", font=('times new roman', 15, 'bold'),
                                    bd=20)
            ...
            self.labelPubID = Label(self.frameDetails, text="Publication ID : ", font=('times new roman', 10, 'bold'), bd=10,
                                    bg="SkyBlue2", justify=LEFT)
            self.labelPubID.grid(row=1, column=0)
            self.labelPubName = Label(self.frameDetails, text="Publication Name : ", font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubName.grid(row=2, column=0)
            self.labelPubLang = Label(self.frameDetails, text="Publication Language : ", font=('times new roman', 10, 'bold'),
                                      bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubLang.grid(row=3, column=0)

            self.labelPubType = Label(self.frameDetails, text="Publication Type : ", font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubType.grid(row=4, column=0)

            self.labelPubPrice = Label(self.frameDetails, text="Publication Price : ", font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubPrice.grid(row=5, column=0)

            self.labelPrevPub = Label(self.frameDetails, text="Previous Values", font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPrevPub.grid(row=0, column=1)

            self.labelPubID = Label(self.frameDetails, text=sPublications[pubName].paper_id, font=('times new roman', 10, 'bold'),
                                    bd=10,
                                    bg="SkyBlue2", justify=LEFT)
            self.labelPubID.grid(row=1, column=1)
            self.labelPubName = Label(self.frameDetails, text=sPublications[pubName].paper_name, font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubName.grid(row=2, column=1)
            self.labelPubLang = Label(self.frameDetails, text=sPublications[pubName].language, font=('times new roman', 10, 'bold'),
                                      bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubLang.grid(row=3, column=1)
            self.labelPubType = Label(self.frameDetails, text=sPublications[pubName].paper_type, font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubType.grid(row=4, column=1)
            self.labelPubPrice = Label(self.frameDetails, text=sPublications[pubName].price, font=('times new roman', 10, 'bold'),
                                       bd=10,
                                       bg="SkyBlue2", justify=LEFT)
            self.labelPubPrice.grid(row=5, column=1)

            self.labelNewPub = Label(self.frameDetails, text="Change Values", font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            ...
            self.labelPubType = Label(self.frameDetails, text=sPublications[pubName].paper_type,
                                      font=('times new roman', 10, 'bold'), bd=10,
                                      bg="SkyBlue2", justify=LEFT)
            self.labelPubType.grid(row=4, column=2)


            self.newpName = StringVar()
            self.eNewpName = Entry(self.frameDetails, width=15, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                              borderwidth=1,
                              textvariable=self.newpName)
            self.eNewpName.grid(row=2, column=2, padx=10, pady=10)

            self.newpPrice = DoubleVar()
            self.eNewpPrice = Entry(self.frameDetails, width=5, font=('times new roman', 12), bg="white", fg="black",
                                   relief="solid",
                                   borderwidth=1,
    ...
    def editCustomer(self):
        self.reset()
        self.labelTitle = Label(self.frame2, text="Edit Customer Details", font=('times new roman', 15, 'bold'),
                                bd=20)
        self.labelTitle.grid(row=0, column=0, columnspan=2, pady=40)
        ...
        self.labelUser = Label(self.editFrame, text="Customer ID   ", font=('times new roman', 12, 'bold'), bg="SkyBlue2", bd=20)
        self.labelUser.grid(row=1, column=0, padx=20)
        self.editID = StringVar()
        self.eUsername = Entry(self.editFrame, width=30, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                               borderwidth=1,
                               textvariable=self.editID)
        self.eUsername.grid(row=2, column=0, padx=20)

        self.labelUser = Label(self.editFrame, text="Customer Name  ", font=('times new roman', 12, 'bold'), bg="SkyBlue2", bd=20)
    ...
    def editAddress(self, customer):
        self.reset()
        self.labelTitle = Label(self.frame2, text="Edit Address", font=('times new roman', 15, 'bold'), bd=20)
        self.labelTitle.grid(row=0, column=0, columnspan=2, pady=40)
        self.frameDetails = Frame(self.frame2, width=1000, height=100, bd=7, relief='ridge',
                                  bg="SkyBlue2")
        self.frameDetails.grid(row=1, column=0)
        ...
        # ====================            Previous Address        ===================================================================
        self.prevAddress = Label(self.frameDetails, text="Previous Address", font=('times new roman', 10, 'bold'), bd=10,
                                 bg="SkyBlue2", justify=LEFT)
        self.prevAddress.grid(row=0, column=4)

        self.labelPrevStreetNo = Label(self.frameDetails, text=customer["Address"][0], font=('times new roman', 10, 'bold'),
                                       bd=10,
                                       bg="SkyBlue2", justify=LEFT)
        self.labelPrevStreetNo.grid(row=1, column=4)

        self.labelPrevRoadNo = Label(self.frameDetails, text=customer["Address"][1], font=('times new roman', 10, 'bold'),
                                     bd=10,
                                     bg="SkyBlue2", justify=LEFT)
        self.labelPrevRoadNo.grid(row=2, column=4)

        self.labelPrevHouseNo = Label(self.frameDetails, text=customer["Address"][2], font=('times new roman', 10, 'bold'),
                                      bd=10,
                                      bg="SkyBlue2", justify=LEFT)
        self.labelPrevHouseNo.grid(row=3, column=4)

        # ====================            New Address        ========================================================
        self.prevAddress = Label(self.frameDetails, text="New Address", font=('times new roman', 10, 'bold'), bd=10,
                                 bg="SkyBlue2", justify=LEFT)
        self.prevAddress.grid(row=0, column=5)
        self.SNo = IntVar()
        self.eSNo = Entry(self.frameDetails, width=5, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                          borderwidth=1,
                          textvariable=self.SNo)
        self.eSNo.grid(row=1, column=5, padx=10, pady=10)

        self.RNo = IntVar()
        self.eRNo = Entry(self.frameDetails, width=5, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                          borderwidth=1,
                          textvariable=self.RNo)
        self.eRNo.grid(row=2, column=5, padx=10, pady=10)

        self.HNo = StringVar()
        self.eHNo = Entry(self.frameDetails, width=5, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                          borderwidth=1,
                          textvariable=self.HNo)
        self.eHNo.grid(row=3, column=5, padx=10, pady=10)

        self.btnReturn = Button(self.frameDetails, text="Return", command=lambda: self.displayButtons(),
                                font=('times new roman', 12, 'bold'), width=10)
    ...
    def editDuration(self, customer):
        ...
        self.frameSubs = LabelFrame(self.frame2, text="Select Subscription", font=('times new roman', 12, 'bold'), padx=12)
        self.frameSubs.grid(row=3, column=0, pady=20)
        ...
        Radiobutton(self.frameSubs, text="English", variable=self.v1, font=('times new roman', 10),
                    command=lambda: self.dropDownPubForSub2(customer),
                    value="English").grid(row=1, column=0)
        Radiobutton(self.frameSubs, text="Hindi", variable=self.v1, font=('times new roman', 10),
                    command=lambda: self.dropDownPubForSub2(customer),
                    value="Hindi").grid(row=1, column=1)
        Radiobutton(self.frameSubs, text="Telugu", variable=self.v1, font=('times new roman', 10),
                    command=lambda: self.dropDownPubForSub2(customer),
                    value="Telugu").grid(row=1, column=2)
        ...
        if len(self.publicationNames) != 0:
            self.publicationsDrop2 = OptionMenu(self.frameSubs, self.clickedPublication, *self.publicationNames)
            self.publicationsDrop2.config(font=('times new roman', 10, 'bold'))
            self.publicationsDrop2.grid(row=2, column=0, padx=10, columnspan=3)
        self.btnSelect = Button(self.frameSubs, text="Select", font=('times new roman', 12, 'bold'),
    ...
    def editDur(self, customer):
        self.reset()
        self.labelTitle = Label(self.frame2, text="Edit Duration", font=('times new roman', 15, 'bold'), bd=20)
        self.labelTitle.grid(row=0, column=0, columnspan=2, pady=40)
        self.frameDetails = Frame(self.frame2, width=1000, height=100, bd=7, relief='ridge',
                                  bg="SkyBlue2")
        self.frameDetails.grid(row=1, column=0)
        ...
        self.labelPubLang = Label(self.frameDetails, text="Publication Language : ", font=('times new roman', 10, 'bold'), bd=10,
                                  bg="SkyBlue2", justify=LEFT)
        self.labelPubLang.grid(row=3, column=3)


        # ====================            Previous Address        ===================================================================
        self.prevValues = Label(self.frameDetails, text="Previous Values", font=('times new roman', 10, 'bold'), bd=10,
                                 bg="SkyBlue2", justify=LEFT)
    ...
    def addSubscriptions(self, customer):
        self.reset()
        self.labelTitle1 = Label(self.frame2, text="Add Subscription", font=('times new roman', 15, 'bold'),
                                 bd=20)
        ...
        self.paperLanguage1 = Label(self.frameSubs, text="Language ", font=('times new roman', 12, 'bold'), bd=10)
        ...
        self.publicationsDrop1.config(font=('times new roman', 10, 'bold'))
        self.publicationsDrop1.grid(row=2, column=0, padx=10, columnspan=3)

        self.labelFromDate1 = Label(self.frameSubs, text="From Date", font=('times new roman', 12, 'bold'), bd=10,
                                    justify=LEFT)
        ...
        self.labelToDate1 = Label(self.frameSubs, text="To Date", font=('times new roman', 12, 'bold'), bd=10,
                                  justify=LEFT)
        ...
        self.btnAdd1 = Button(self.frameSubs, text="Add", font=('times new roman', 12, 'bold'), width=20, command=lambda: self.editAdd(customer))
    ...
    def cancelSubscription(self, customer):
        self.reset()
        self.labelTitle = Label(self.frame2, text="Cancel Subscription", font=('times new roman', 15, 'bold'),
                                bd=20)
        self.labelTitle.grid(row=0, column=0, columnspan=2, pady=40)
        self.frameSubs = LabelFrame(self.frame2, text="Cancel Subscriptions", font=('times new roman', 12, 'bold'), padx=12)
        self.frameSubs.grid(row=3, column=0, pady=20)
        ...
        if len(self.publicationNames) != 0:
            ...
            self.publicationsDrop2.config(font=('times new roman', 10, 'bold'))
            self.publicationsDrop2.grid(row=2, column=0, padx=10, columnspan=3)
        self.cancelBtn = Button(self.frameSubs, text="Delete Subscription", font=('times new roman', 12, 'bold'),
    ...
    def customerBills(self):
        ...
        self.labelUser = Label(self.frame2, text="Cutomer ID   ", font=('times new roman', 12, 'bold'), bd=20)
        self.labelUser.grid(row=1, column=0, padx=20)
        self.editID = StringVar()
        self.eUsername = Entry(self.frame2, width=30, font=('times new roman', 12), bg="gray80", fg="black", borderwidth=3,
                               textvariable=self.editID)
        self.eUsername.grid(row=2, column=0, padx=20)

        self.labelUser = Label(self.frame2, text="Customer Name  ", font=('times new roman', 12, 'bold'), bd=20)
        self.labelUser.grid(row=1, column=1, padx=20)
        self.editName = StringVar()
        self.eUsername = Entry(self.frame2, width=30, font=('times new roman', 12), bg="gray80", fg="black", borderwidth=3,
                               textvariable=self.editName)
    ...
    def summary(self):
        ...
        self.labelAddCustomers = Label(self.frame2, text="Summary of The Month", font=('times new roman', 17, 'bold'),
                                       bd=20)
        self.labelAddCustomers.grid(row=0, column=0, pady=40)
        ...
        #                           bg="SkyBlue2")
        # self.frameDetails.grid(row=1, column=0, columnspan=2)

        self.frameX = Frame(self.frame2,width=1398, height=1037,bg="SkyBlue2")
        self.frameX.grid(row=1, column=0, columnspan=2, sticky="nw")

        self.frameX.grid_rowconfigure(0, weight=1)
        self.frameX.grid_columnconfigure(0, weight=1)
        #self.frameX.grid_propagate(False)

        self.canvas = ttk.Canvas(self.frameX, bg="yellow")
        self.canvas.grid(row=0, column=0, sticky="news")

        vsb = ttk.Scrollbar(self.frameX, orient="vertical", command=self.canvas.yview)
        vsb.grid(row=0, column=2, sticky='ns')
        self.canvas.configure(yscrollcommand=vsb.set)

        hsb = ttk.Scrollbar(self.frameX, orient="horizontal", command=self.canvas.xview)
        hsb.grid(row=1, column=0, sticky='ew')
        self.canvas.configure(xscrollcommand=hsb.set)

        self.frameDetails = Frame(self.canvas, bg="skyblue2", width=1398, height=1037)
        self.canvas.create_window((0, 0), window=self.frameDetails)

        self.btnExit = Button(self.frame2, text="Exit", command=lambda: self.ExitSum(),
                                   font=('times new roman', 12, 'bold'), width=10)
        self.btnExit.grid(row=0, column=1)

        self.labelName = Label(self.frameDetails, text="Full Name ", font=('times new roman', 12, 'bold'), bd=10, bg="SkyBlue2",
                               justify=LEFT)
        self.labelName.grid(row=0, column=0, rowspan=2)
        ...
        self.labelHouseNo.grid(row=1, column=6)
        # ====================            Subscriptions           ===================================================================================
        self.labelSubscriptions=Label(self.frameDetails, text="Subscription", font=('times new roman', 12, 'bold'), bd=20,
                                  bg="SkyBlue2")
        self.labelSubscriptions.grid(row=0,column=7,columnspan=6)

        self.labelSubscriptionsName=Label(self.frameDetails, text="Subscription Name", font=('times new roman', 10, 'bold'), bd=10,
                                   bg="SkyBlue2", justify=LEFT)
        self.labelSubscriptionsName.grid(row=1,column=7)

        self.labelSubscriptionsID = Label(self.frameDetails, text="Subscription ID", font=('times new roman', 10, 'bold'), bd=10,
                                            bg="SkyBlue2", justify=LEFT)
        self.labelSubscriptionsID.grid(row=1, column=8)

        self.labelSubscriptionsFromDate = Label(self.frameDetails, text="From Date", font=('times new roman', 10, 'bold'), bd=10,
                                            bg="SkyBlue2", justify=LEFT)
        self.labelSubscriptionsFromDate.grid(row=1, column=9)

        self.labelSubscriptionsToDate = Label(self.frameDetails, text="To Date", font=('times new roman', 10, 'bold'), bd=10,
                                            bg="SkyBlue2", justify=LEFT)
        ...
        for i in customers:
            ...
            for j in i.subscriptions:
                print(j, type(j.to_date), type(SetDate))
                if j.from_date <= SetDate and j.to_date >= SetDate-(datetime.timedelta(days=30)):
                    flag=True
                    break
            if flag==True:
                self.labelSubscriptionsToDate = Label(self.frameDetails, text=i.name, font=('times new roman', 10, 'bold'), bd=10,
                                                      bg="SkyBlue2", justify=LEFT)
                self.labelSubscriptionsToDate.grid(row=ind, column=0)
                self.labelSubscriptionsToDate = Label(self.frameDetails, text=i.ID, font=('times new roman', 10, 'bold'), bd=10,
                                                      bg="SkyBlue2", justify=LEFT)
        ...
        self.frameDetails.update_idletasks()

        w = (self.labelSubscriptions.winfo_width())*10
        h = self.labelSubscriptions.winfo_height()*(ind-1)
        print(w,h)
        self.frameX.config(width=w + vsb.winfo_width(),height=h+hsb.winfo_width())
    ...
    def ExitSum(self):
        ...
        self.btnAddCustomers = Button(self.frame1, text="Add Customers", command=lambda: self.addCustomers(),
                                      font=('times new roman', 12, 'bold'), width=20)
        self.btnAddCustomers.grid(row=0, column=0, padx=40, pady=22)

        self.btnEditCustomers = Button(self.frame1, text="Edit Customers Details", command=lambda: self.editCustomer(),
                                       font=('times new roman', 12, 'bold'), width=20)
        self.btnEditCustomers.grid(row=1, column=0, padx=40, pady=22)

        self.btnAddPublication = Button(self.frame1, text="Add Publication", command=lambda: self.addPublication(),
                                        font=('times new roman', 12, 'bold'), width=20)
        self.btnAddPublication.grid(row=2, column=0, padx=40, pady=22)

        self.btnEditPublications = Button(self.frame1, text="Edit Publications", command=lambda: self.editPublication(),
                                          font=('times new roman', 12, 'bold'), width=20)
        self.btnEditPublications.grid(row=3, column=0, padx=40, pady=22)

        self.btnCustomerBills = Button(self.frame1, text="Show Customer Bills", command=lambda: self.customerBills(),
                                       font=('times new roman', 12, 'bold'), width=20)
        self.btnCustomerBills.grid(row=4, column=0, padx=40, pady=22)

        self.btnSummary = Button(self.frame1, text="Show Summary", command=lambda: self.summary(),
                                 font=('times new roman', 12, 'bold'), width=20)
        self.btnSummary.grid(row=5, column=0, padx=40, pady=22)

        self.btnAddDeliverer = Button(self.frame1, text="Add Deliverer", command=lambda: self.addDeliverer(),
                                      font=('times new roman', 12, 'bold'), width=20)
        self.btnAddDeliverer.grid(row=6, column=0, padx=40, pady=22)

        self.btnDeliveryDetails = Button(self.frame1, text="Deliverer Details", command=lambda: self.delivererDetails(),
                                         font=('times new roman', 12, 'bold'), width=20)
        self.btnDeliveryDetails.grid(row=7, column=0, padx=40, pady=22)
    ...
    def addDeliverer(self):
        ...
        self.labelAddDeliverer = Label(self.frame2, text="Add Deliverer", font=('times new roman', 17, 'bold'),
                                       bd=20)
        ...
        self.labelName = Label(self.frameDetails, text="Deliverer Name ", font=('times new roman', 12, 'bold'), bd=10,
                               bg="SkyBlue2", justify=LEFT)
        self.labelName.grid(row=0, column=0, rowspan=2)
        self.name = StringVar()
        self.eName = Entry(self.frameDetails, width=30, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                           borderwidth=1,
                           textvariable=self.name)
        self.eName.grid(row=2, column=0, padx=10)

        self.labelID = Label(self.frameDetails, text="Deliverer ID", font=('times new roman', 12, 'bold'), bd=10,
                             bg="SkyBlue2", justify=LEFT)
        self.labelID.grid(row=0, column=1, rowspan=2)
        self.cID = StringVar()
        self.ecID = Entry(self.frameDetails, width=12, font=('times new roman', 12), bg="white", fg="black", relief="solid",
        ...
        self.labelPassword = Label(self.frameDetails, text="Deliverer Password", font=('times new roman', 12, 'bold'), bd=10,
                                   bg="SkyBlue2", justify=LEFT)
        self.labelPassword.grid(row=0, column=2, rowspan=2)
        self.password = StringVar()
        self.epassword = Entry(self.frameDetails, width=12, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                               borderwidth=1,
                               textvariable=self.password)
        self.epassword.grid(row=2, column=2, padx=10)

        self.btnAdd = Button(self.frameDetails, text="Add", font=('times new roman', 12, 'bold'), width=10, command=lambda: self.addDelDet())
    ...
    def delivererDetails(self):
        ...
        self.labelAddDeliverer = Label(self.frame2, text="Deliverers Details", font=('times new roman', 17, 'bold'),
                                       bd=20)
        self.labelAddDeliverer.grid(row=0, column=0, columnspan=2, pady=40)
        ...
        self.labeldName = Label(self.frameDetails, text="Deliverer Name", font=('times new roman', 10, 'bold'), bd=10,
                                   bg="SkyBlue2", justify=LEFT)
        self.labeldName.grid(row=0, column=0)
        self.dName = StringVar()
        self.edName = Entry(self.frameDetails, width=12, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                          borderwidth=1,
                          textvariable=self.dName)
        self.edName.grid(row=0, column=1, padx=10)


        self.labeldID = Label(self.frameDetails, text="Deliverer ID", font=('times new roman', 10, 'bold'), bd=10,
                                   bg="SkyBlue2", justify=LEFT)
        self.labeldID.grid(row=1, column=0)

        self.dID = StringVar()
        self.edID = Entry(self.frameDetails, width=12, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                          borderwidth=1,
            ...
            if i.name == deliverer:
                for j in i.Customers:
                    for k in j.subscriptions:
                        print(type(k.from_date), type(k.to_date), type(SetDate))
                        if k.from_date <= SetDate and k.to_date >= SetDate:
                            self.wage+=0.025*k.publication.price
        self.labelWage = Label(self.frameDetails, text="Today's Wage : "+str(self.wage), font=('times new roman', 12, 'bold'), bg="SkyBlue2", bd=20)
        self.labelWage.grid(row=2, column=1, padx=20)

    def customerBills(self):
        self.reset()
        self.labelTitle = Label(self.frame2, text="Customer bills", font=('times new roman', 15, 'bold'),
                                bd=20)
        self.labelTitle.grid(row=0, column=0, columnspan=2, pady=40)

        self.editFrame = Frame(self.frame2, width=542, height=70, bd=7, bg="SkyBlue2", relief='ridge', padx=12, pady=12)
        self.editFrame.grid(row=1, column=1)
        self.labelUser = Label(self.editFrame, text="Cutomer ID   ", font=('times new roman', 12, 'bold'), bg="SkyBlue2", bd=20)
        self.labelUser.grid(row=1, column=0, padx=20)
        self.editID = StringVar()
        self.eUsername = Entry(self.editFrame, width=30, font=('times new roman', 12), bg="white", fg="black", relief="solid",
                               borderwidth=1,
    ...
    def displaySubscription(self, customer):
        self.reset()
        self.labelAddCustomers = Label(self.frame2, text="Customer Bills", font=('times new roman', 17, 'bold'),
                                       bd=20)
        self.labelAddCustomers.grid(row=0, column=0, columnspan=2, pady=40)
        self.frameDetails = Frame(self.frame2, width=1000, height=100, bd=7, relief='ridge',
                                  bg="SkyBlue2")
        ...
        self.labelName = Label(self.frameDetails, text=customer["CustomerName"], font=('times new roman', 12, 'bold'), bd=10,
                               bg="SkyBlue2",
                               justify=LEFT)
        ...
        self.labelID = Label(self.frameDetails, text=customer["CustomerID"], font=('times new roman', 12, 'bold'), bd=10,
                             bg="SkyBlue2", justify=LEFT)
        ...
        self.labelPhoneNumber = Label(self.frameDetails, text=customer["PhoneNumber"], font=('times new roman', 12, 'bold'),
                                      bd=10, bg="SkyBlue2", justify=LEFT)
        ...
        self.labelSubscriptionsID = Label(self.subscriptionDetails, text="Subscription ID", font=('times new roman', 10, 'bold'),
                                          bd=10,
                                          justify=LEFT)
        self.labelSubscriptionsID.grid(row=0, column=1)

        self.labelSubscriptionsFromDate = Label(self.subscriptionDetails, text="From Date", font=('times new roman', 10, 'bold'),
                                                bd=10,
                                                justify=LEFT)
        self.labelSubscriptionsFromDate.grid(row=0, column=2)

        self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text="To Date", font=('times new roman', 10, 'bold'),
                                              bd=10,
                                              justify=LEFT)
        self.labelSubscriptionsToDate.grid(row=0, column=3)
        self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text="Paper Price", font=('times new roman', 10, 'bold'),
                                              bd=10, justify=LEFT)
        self.labelSubscriptionsToDate.grid(row=0, column=4)
        self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text="Duration", font=('times new roman', 10, 'bold'),
                                              bd=10, justify=LEFT)
        self.labelSubscriptionsToDate.grid(row=0, column=5)
        self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text="Amount", font=('times new roman', 10, 'bold'),
                                              bd=10, justify=LEFT)
        ...
        for i in customer2.subscriptions:
            ...
            # now=date.today()
            now = i.from_date
            temp = now.strftime(format)
            self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text=temp,
                                                  font=('times new roman', 10, 'bold'),
                                                  bd=10, justify=LEFT)
            self.labelSubscriptionsToDate.grid(row=ind, column=2)
            format = "%d/%m/%Y"
            ...
            now = SetDate
            now = now.strftime(format)
            self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text=now, font=('times new roman', 10, 'bold'),
                                                  bd=10, justify=LEFT)
            ...
            self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text=temp, font=('times new roman', 10, 'bold'),
                                                  bd=10, justify=LEFT)
            self.labelSubscriptionsToDate.grid(row=ind, column=4)
            ...
            self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text=duration, font=('times new roman', 10, 'bold'),
                                                  bd=10, justify=LEFT)
            self.labelSubscriptionsToDate.grid(row=ind, column=5)
            self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text=cost, font=('times new roman', 10, 'bold'),
                                                  bd=10, justify=LEFT)
            self.labelSubscriptionsToDate.grid(row=ind, column=6)
            ind = ind + 1
        self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text="TOTAL COST", font=('times new roman', 10, 'bold'),
                                              bd=10, justify=LEFT)
        self.labelSubscriptionsToDate.grid(row=ind, column=5)
        self.labelSubscriptionsToDate = Label(self.subscriptionDetails, text=TotalCost, font=('times new roman', 10, 'bold'),
                                              bd=10, justify=LEFT)
        self.labelSubscriptionsToDate.grid(row=ind, column=6)
        self.labelSubscriptionsToDate = Button(self.subscriptionDetails, text="PAID", font=('times new roman', 10, 'bold'),
                                               bd=10, width=10, bg="SkyBlue2", command=lambda: self.changeFromDate(customer),
                                               justify=LEFT)
        self.labelSubscriptionsToDate.grid(row=ind + 1, column=5)
        self.labelSubscriptionsToDate = Button(self.subscriptionDetails, text="EXIT", font=('times new roman', 10, 'bold'),
                                               bd=10, width=10, bg="SkyBlue2", command=lambda: self.clear(),
                                               justify=LEFT)
        self.labelSubscriptionsToDate.grid(row=ind + 1, column=6)


    def changeFromDate(self, customer):
        for i in customers_:
            for j in i["Subscriptions"]:
                j["from_date"] = SetDate.strftime("%m/%d/%y")
        for i in customers:
            if i.name==customer["CustomerName"]:
                for j in i.subscriptions:
                    j.from_date = SetDate
        messagebox.showinfo("Success", "Bill paid successfuly", parent=self.master)
...
class DelivererWindow:
    def __init__(self, master, deliverer):
        ...
        self.labelCustomerName = Label(self.frame1, text="Customer Name", font=('times new roman', 10, 'bold'),bg="Skyblue2",
                                       bd=20)
        self.labelCustomerName.grid(row=0, column=0, padx=10, pady=5)

        self.labelPhoneNum = Label(self.frame1, text="Customer Phone Number", font=('times new roman', 10, 'bold'),bg="Skyblue2",
                                       bd=20)
        self.labelPhoneNum.grid(row=0, column=1, padx=10, pady=5)

        self.labelStreetNum = Label(self.frame1, text="Street No", font=('times new roman', 10, 'bold'),bg="Skyblue2",
                                       bd=20)
        self.labelStreetNum.grid(row=0, column=2, padx=10, pady=5)

        self.labelRoadNum = Label(self.frame1, text="Road No", font=('times new roman', 10, 'bold'), bg="Skyblue2",
                                   bd=20)
        self.labelRoadNum.grid(row=0, column=3, padx=10, pady=5)

        self.labelHouseNum = Label(self.frame1, text="House No", font=('times new roman', 10, 'bold'), bg="Skyblue2",
                                       bd=20)
        self.labelHouseNum.grid(row=0, column=4, padx=10, pady=5)

        self.labelCustomerSub = Label(self.frame1, text="Subscription", font=('times new roman', 10, 'bold'), bg="Skyblue2",
                                       bd=20)
        self.labelCustomerSub.grid(row=0, column=5, padx=10, pady=5)

        self.labelTFare = Label(self.frame1, text="Wages", font=('times new roman', 10, 'bold'), bg="Skyblue2",
                                   bd=20)
        ...
        for i in deliverer.Customers:
            self.labelcustomerN = Label(self.frame1, text=i.name, font=('times new roman', 10, 'bold'),bg="Skyblue2",
                                           bd=20)
            self.labelcustomerN.grid(row=k+1, column=0, padx=10)

            self.labelcustomerPh = Label(self.frame1, text=i.phone_number, font=('times new roman', 10, 'bold'),width=15,bg="Skyblue2",
                                       bd=20)
            self.labelcustomerPh.grid(row=k+1, column=1, padx=10)

            self.labelcustomerSt = Label(self.frame1, text=i.address.street_number, font=('times new roman', 10, 'bold'),bg="Skyblue2",
                                         bd=20)
            self.labelcustomerSt.grid(row=k + 1, column=2, padx=10)

            self.labelcustomerRd = Label(self.frame1, text=i.address.road_number, font=('times new roman', 10, 'bold'),bg="Skyblue2",
                                         bd=20)
            self.labelcustomerRd.grid(row=k + 1, column=3, padx=10)

            self.labelcustomerHs = Label(self.frame1, text=i.address.house_number, font=('times new roman', 10, 'bold'),bg="Skyblue2",
                                         bd=20)
            ...
            for j in i.subscriptions :
                self.labelcustomerSub = Label(self.frame1, text=j.publication.paper_name, font=('times new roman', 10, 'bold'),
                                             bg="Skyblue2", bd=20)
                self.labelcustomerSub.grid(row=k + 1, column=5, padx=10)

                self.labelWage = Label(self.frame1, text=str(j.publication.price*0.025), font=('times new roman', 10, 'bold'),
                                              bg="Skyblue2", bd=20)
                self.labelWage.grid(row=k + 1, column=6, padx=10)
                totalCost+=(j.publication.price*0.025)
                k=k+1

        self.labelTotal = Label(self.frame1, text="Total Wage :", font=('times new roman', 10, 'bold'),
                               bg="Skyblue2", bd=20)
        self.labelTotal.grid(row=k + 1, column=5, padx=10)


        self.labelTotalWage = Label(self.frame1, text=str(totalCost), font=('times new roman', 10, 'bold'),
                               bg="Skyblue2", bd=20)
        self.labelTotalWage.grid(row=k + 1, column=6, padx=10)
